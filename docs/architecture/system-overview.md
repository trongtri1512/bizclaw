...
| **Production** | Your domain, Nginx reverse proxy, subdomain routing |
...
|--------|-----------|------|
| platform | apps.your-domain.com | 3001 |
| demo | demo.your-domain.com | 10001 |
| sales | sales.your-domain.com | 10002 |
